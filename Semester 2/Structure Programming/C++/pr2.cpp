...
int main()
{
	...
	else if(date<=19 && month=="February" && date<=31 && date>=1){
		cout<<"Your Zodiac is Aquarius";
		return 0;
	}
	else if(date>=20 && month=="February" && date<=31 && date>=1){
	...
	else if(date<=19 && month=="April" && date<=31 && date>=1){
		cout<<"Your Zodiac is Aries";
		return 0;
	}
	else if(date>=20 && month=="April" && date<=31 && date>=1){
	...
	else if(date<=21 && month=="June" && date<=31 && date>=1){
		cout<<"Your Zodiac is Gemini";
		return 0;
	}
	else if(date>=22 && month=="June" && date<=31 && date>=1){
	...
	else if(date<=22 && month=="September" && date<=31 && date>=1){
		cout<<"Your Zodiac is Virgo";
		return 0;
	}
	else if(date>=23 && month=="September" && date<=31 && date>=1){
	...
	else if(date<=22 && month=="November" && date<=31 && date>=1){
		cout<<"Your Zodiac is Scorpio";
		return 0;
	}
	else if(date>=23 && month=="November" && date<=31 && date>=1){
